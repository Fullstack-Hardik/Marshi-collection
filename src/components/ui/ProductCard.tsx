    ...
    <>
      ...
      >
        ...
        <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between">
          ...
          <div className="flex flex-col mt-4 pt-4 border-t border-[var(--text-primary)]/10">
            ...
            <a
              ...
              className="w-full py-2 bg-[#25D366] text-white rounded-lg font-bold text-xs sm:text-sm shadow-md hover:bg-[#128C7E] transition-colors flex items-center justify-center gap-2"
            >
